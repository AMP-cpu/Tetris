...
void Server_loop(sf::RenderWindow& window, sf::Font font, User& user, Score& score, bool& gameOver) {
...
void Client_loop(sf::RenderWindow& window, sf::Font font, User& user, Score& score, bool& gameOver, bool& menu) {
...
void tetris(sf::RenderWindow& window, sf::Font font, User& user, Score& score, bool& gameOver, bool& menu, int& network) {
    ...
    if (network == 1){
        Server_loop(window, font, user, score, gameOver);
    }
    else if (network == 2)
    {
        Client_loop(window, font, user, score, gameOver, menu);
    }
    else {
        menu = true;
    }
